...
android {
    namespace = "com.magiclane.sdk.examples.multisurfinfragrecycler"

    compileSdk = shared.versions.compileSdkVersion.get().toInt()

    defaultConfig {
        applicationId = "com.magiclane.sdk.examples.multisurfinfragrecycler"
...
dependencies {
    ...
    implementation(shared.androidx.asynclayoutinflater)
