...
import com.magiclane.sdk.examples.whatsnearbycategory.databinding.ActivityMainBinding
import com.magiclane.sdk.examples.whatsnearbycategory.databinding.DialogLayoutBinding
import com.magiclane.sdk.examples.whatsnearbycategory.databinding.ListItemBinding
        ...
        onCompleted = onCompleted@{ results, errorCode, _ ->
            ...
            when (errorCode) {
                GemError.NoError -> {
                    ...
                    binding.listView.adapter = CustomAdapter(reference, results, imageSize)
                    decrement()
                }
