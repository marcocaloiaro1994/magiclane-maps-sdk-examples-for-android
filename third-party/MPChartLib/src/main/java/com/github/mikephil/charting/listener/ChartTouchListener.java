...
public abstract class ChartTouchListener<T extends Chart<?>> extends GestureDetector.SimpleOnGestureListener implements View.OnTouchListener {
    ...
    protected static final int LEFT_FIX_RIGHT_MOVE = 1;
    protected static final int RIGHT_FIX_LEFT_MOVE = 2;
    protected static final int AT_LEAST_ONE_MOVING = 3;
    protected static final int EQUIDIST_MOVING = 4;
    protected static final int BOTH_MOVING_RANDOMLY = 5;
    protected static final int DEFAULT = 6;

    protected int mFingersMode = NONE;
    ...
    protected static float distance(float eventX, float startX) {
        float dx = eventX - startX;
