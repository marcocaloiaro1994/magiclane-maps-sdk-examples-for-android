...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
     ...
     */
    protected int mMaxVisibleCount = 9000;
    ...
    private  float mDistanceAroundPin = 0;
    private  boolean mIsPinOnLeftSide = false;
    ...
    public void setPinOnLeftSide(boolean isPinOnLeftSide){
        mIsPinOnLeftSide = isPinOnLeftSide;
    }

    public boolean isPinOnLeftSide(){
        return mIsPinOnLeftSide;
    }
    ...
    public void setDistanceAroundPin(float distanceAroundPin){
        mDistanceAroundPin = distanceAroundPin;
    }

    public float getDistanceAroundPin(){
        return mDistanceAroundPin;
    }
}
